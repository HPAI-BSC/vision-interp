...
def get_activation_addition_output_post_hook_v2(vector: Float[Tensor, "batch_size d_model"], coeff: Float[Tensor, ""], position: Union[str, List[int]] = "input", intervention_type: str = 'addition'):
    def hook_fn(module, input, output):
        nonlocal vector
