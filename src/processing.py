...
def processing(inputs_dict, processor, cfg, tokenizer=None):
    ...
    if is_gemma_model(cfg.model_name.lower()):
    ...
    elif 'paligemma2' in cfg.model_name.lower():
        ...
        if cfg.submodel == 'enc' and cfg.get_full_model == False:
            ...
            pixel_values = processor_output['pixel_values']
            processor_output = {'pixel_values': pixel_values}
    elif any(x in cfg.model_name.lower() for x in ('qwen2-vl', 'qwen2.5-vl', 'mimo-vl', 'aloe-vision-7b')):
